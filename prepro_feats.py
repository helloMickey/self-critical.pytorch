...
if __name__ == "__main__":
    ...
    main(params)
# CUDA_VISIBLE_DEVICES=2 nohup python scripts/prepro_feats.py > process.log 2>&1 &
# CUDA_VISIBLE_DEVICES=2 nohup python prepro_feats.py --input_json data/dataset_coco.json --output_dir data/cocotalk --images_root /disk2/sharing_data/coco/images > process.log 2>&1 &